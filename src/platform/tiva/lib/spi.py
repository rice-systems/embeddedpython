...
/* GPIO for SPI */
#define SPI_SSI_BASE            SSI3_BASE
#define SPI_SSI_SYSCTL_PERIPH   SYSCTL_PERIPH_SSI3
#define SPI_GPIO_PORT_BASE      GPIO_PORTQ_BASE
#define SPI_GPIO_SYSCTL_PERIPH  SYSCTL_PERIPH_GPIOQ
#define SPI_SSI_CLK             GPIO_PIN_0
#define SPI_SSI_TX              GPIO_PIN_3
#define SPI_SSI_RX              GPIO_PIN_2
...
GPIO_STRENGTH_4MA = 0x00000002 # driverlib/gpio.h
GPIO_PIN_TYPE_STD_WPU = 0x0000000A # driverlib/gpio.h


def init_cs(periph, port, pin):
    sysctl.SysCtlPeripheralEnable(periph)
    gpio.GPIOPinTypeGPIOOutput(port, pin)
    gpio.GPIOPadConfigSet(port, pin, GPIO_STRENGTH_4MA, GPIO_PIN_TYPE_STD_WPU)
...
def init():
    ...
    SSIConfigSetExpClk(SPI_SSI_BASE, 120000000, SSI_FRF_MOTO_MODE_0,
