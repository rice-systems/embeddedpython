...
Section "Uninstall"
  ...
  Delete "$INSTDIR\gtksourceview2.pyd"
  ...
  Delete "$INSTDIR\libgtksourceview-2.0-0.dll"
  ...
  Delete "$INSTDIR\NSI.dll"
  Delete "$INSTDIR\owl.ico"
  Delete "$INSTDIR\owl.png"
  Delete "$INSTDIR\owlide.exe"
  Delete "$INSTDIR\pango.pyd"
  Delete "$INSTDIR\pangocairo.pyd"
  Delete "$INSTDIR\projecttree.glade"
